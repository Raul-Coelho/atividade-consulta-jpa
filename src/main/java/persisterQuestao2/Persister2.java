...
public class Persister2 {
    ...
    public void initPersistence(EntityManager em) {
        ...
        Escritor escritor3 = new Escritor(2,Arrays.asList(publicacao2),3,"IAN",LocalDate.of(1999, 1, 1));
        Escritor escritor4 = new Escritor(7,Arrays.asList(publicacao3),7,"RAUL",LocalDate.of(1994, 1, 1));
        ...
        Revisor revisor3 = new Revisor("5.7",Arrays.asList(publicacao2),6,"FON",LocalDate.of(1998, 5, 6));
        Revisor revisor4 = new Revisor("6.7",Arrays.asList(publicacao3),8,"Pedro",LocalDate.of(1999, 5, 6));
        Revisor revisor5 = new Revisor("9.7",Arrays.asList(publicacao4),10,"TRAB",LocalDate.of(1991, 5, 6));
